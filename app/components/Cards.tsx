...
export default function Cards() {
  ...
  return (
    <div ref={targetRef}>
      <div
        className={
          (isVisible ? "animate-fadeBody" : "hidden") +
      ...
      >
        <div className=" max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Web 3d portfolio of old computer
            </h5>

            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
              Here is a portfolio made to showcase my learning skill in a
              different technology.
            </p>
            <a
              href="https://gogo200202.github.io/portFolioWindowsXp/"
        ...
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
            ...
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
              Here i build mvc project using Asp.net core for my certificate.
            </p>
            <a
              href="https://github.com/Gogo200202/ProductSellStore"
              className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              See on github
        ...
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
            <a href="#">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                Mp3 player in browser with react
              </h5>
            </a>
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
              Here i build and deploy mp3 player. Using react and github pages
              for deploying.
            </p>

            <div className=" container mx-auto  p-6 grid  grid-cols-1  px-3 py-2  ">
              <a
                href="https://gogo200202.github.io/MusicPlayerApp/"
              ...
              <a
                href="https://github.com/Gogo200202/MusicPlayerApp"
                className=" m-2 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                See on github
                <svg
